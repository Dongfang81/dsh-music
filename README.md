...
- ❤️ **收藏既快又能整理**——红心仍是一键收藏/取消；长按红心或在收藏列表点「收藏到…」，可把同一首歌放进多个自定义目录
...
- **部分歌曲无法播放？** Moony 会依次尝试本地授权音乐、官方直链和精确跨源匹配；找不到原版时会诚实反馈，不会用翻唱、伴奏或现场版冒充。你可以把合法拥有的音频目录加入 `localMusicPaths`，或听取相关替代建议。
